...
<body
	background="${pageContext.request.contextPath}/static/images/timg.jpg">
	<div
	...
	/* background-color:black;	 */ margin-left: -150px; margin-top: -80px;">
			<div class="easyui-panel" title="请登录" data-options="iconCls:'icon-man'">
						...
						<tr>
							...
							<td><input type="text" id="in1" style="width: 90px" value=""
								placeholder="请输入验证码"><span id="yzm"><input
									id="l1" type="text"></input></span><span id="tip"></span></td>
						</tr>
					</table>
